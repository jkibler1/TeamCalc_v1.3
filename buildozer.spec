...
# (str) Package name
package.name = poketeamcalc

# (str) Package domain (needed for android/ios packaging)
package.domain = com.poketeamcalc
...
#android.sdk_path = /root/.buildozer/android/platform/android-ndk-r23c
...
# NOTE HAD TO REMOVE ''
android.gradle_dependencies = com.google.firebase:firebase-ads:10.2.1
